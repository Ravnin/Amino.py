...
class Client:
    def __init__(self, callback = Callbacks, proxies: dict = None, certificatePath = None, socket_trace = False, socketDebugging = False, security = True):
        ...
        self.socket = SocketHandler(self, socket_trace=socket_trace, debug=socketDebugging, security=security)
